                    ...
                    <div class="container">
                        ...
                        <?php foreach ($DataPelanggan as $data) : ?>
                            <form method="POST" action="<?php echo base_url('admin/DataPelanggan/C_EditPelanggan/EditPelangganSave') ?>">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <input type="hidden" class="form-control bg-warning fw-bold" name="id" id="id" value="<?php echo $data['id'] ?>" readonly>
                                        <input type="hidden" class="form-control bg-warning fw-bold" name="id_pppoe" id="id_pppoe" value="<?php echo $data['id_pppoe'] ?>" readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        <label for="name" class="form-label fw-bold fs-5"> Nama : <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-secondary"><i class="bi bi-person-bounding-box text-white"></i></span>
                                            <input type="text" class="form-control fw-bold" name="name" id="name" value="<?php echo $data['name'] ?>" placeholder="Masukkan Nama Customer...">
                                        </div>
                                        <div class="bg-danger">
                                    ...
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control fw-bold" name="start_date" id="start_date" value="<?php echo $data['start_date'] ?>">
                                        </div>
                                        <div class="bg-danger">
                                    ...
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold" name="code_client" id="code_client" value="<?php echo $data['code_client'] ?>" placeholder="Masukkan Kode Customer...">
                                        </div>
                                        <div class="bg-danger">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-secondary"><i class="bi bi-person-bounding-box text-white"></i></span>
                                            <input type="text" class="form-control fw-bold" name="name_pppoe" id="name_pppoe" value="<?php echo $data['name_pppoe'] ?>" placeholder="Masukkan Name PPPOE...">
                                        </div>
                                        <div class="bg-danger">
                                    ...
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold" name="password_pppoe" id="password_pppoe" value="<?php echo $data['password_pppoe'] ?>" placeholder="Masukkan Password PPPOE...">
                                        </div>
                                        <div class="bg-danger">
                                    ...
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold" name="phone" id="phone" value="<?php echo $data['phone'] ?>" placeholder="Masukkan No Telepon...">
                                        </div>
                                        <div class="bg-danger">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold" name="email" id="email" value="<?php echo $data['email'] ?>" placeholder="Masukkan Email Customer...">
                                        </div>
                                        <div class="bg-danger">
                                    ...
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control fw-bold" name="address" id="address" cols="10" rows="3" placeholder="Masukkan Alamat Customer..."><?php echo $data['address'] ?></textarea>
                                        </div>
                                        <div class="bg-danger">
                                    ...
                                    <div class="col-sm-12 col-lg-4 mt-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-secondary"><i class="bi bi-bookmarks-fill text-white"></i></span>
                                            <textarea class="form-control fw-bold" name="description" id="description" cols="10" rows="3" placeholder="Masukkan Keterangan..."><?php echo $data['description'] ?></textarea>
                                        </div>
                                        <div class="bg-danger">
